    ...
    return (
      <main style={{
        ...
        <div style={{background:'#120309',border:'1px solid rgba(255,255,255,.15)',borderRadius:16,padding:24,width:'min(720px,100%)'}}>
          ...
          <p style={{opacity:.8,margin:'0 0 12px'}}>This protects the internal console. Set <code>NEXT_PUBLIC_CONSULT_PASS</code> in Vercel.</p>
          <div style={{display:'flex',gap:8}}>
            ...
            <button
              ...
              style={{padding:'10px 14px', borderRadius:999, fontWeight:800, background:'#F58A07', color:'#0b0710', border:'none'}}
            >Enter</button>
          </div>
  ...
  return (
    <main style={{
      ...
      <div style={{background:'#120309',border:'1px solid rgba(255,255,255,.15)',borderRadius:16,padding:24,width:'min(880px,100%)'}}>
        ...
        <p style={{opacity:.85,margin:0}}>Success — passcode accepted. Replace this area with your full Consultation UI.</p>
      </div>
    </main>
  );
}
